#!/bin/bash
# Build Windows Server 2025 for Proxmox
# 
# Prerequisites:
# 1. Install the Proxmox plugin for Packer:
#    packer plugins install github.com/hashicorp/proxmox
# 
# 2. Upload the Windows Server 2025 ISO to your Proxmox storage
